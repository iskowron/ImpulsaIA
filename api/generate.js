export default async function handler(req, res) {
  ...
  // ── Demo mode — sin autenticacion, limite estricto de tokens ────────────────
  ...
  if (!isDemoMode) {
    // ── Autenticacion normal — verificar JWT de Supabase ─────────────────────
    ...
    try {
      ...
      // frontend already controls this
    }
  }
  ...
  try {
    const response = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({
        ...
        max_tokens: isDemoMode ? 512 : 1024,
