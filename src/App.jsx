...
function AuthScreen({ onAuth }) {
  ...
  return (
    <div className="ll-auth-layout" style={{ minHeight: "100vh", background: "#050508", fontFamily: "'Inter',sans-serif", position: "relative", overflow: "hidden" }}>
      ...
      {/* Right — visual panel */}
      <div className="ll-auth-panel" style={{ position: "relative", overflow: "hidden", display: "flex", flexDirection: "column", justifyContent: "center" }}>
        {/* Background image */}
    ...
    <div style={{ fontFamily: "'Inter',sans-serif", minHeight: "100vh", background: "#050508", color: "#e2e8f0" }}>
      ...
      <header style={{ height: 60, padding: "0 16px", display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 100, background: "rgba(5,5,8,0.9)", backdropFilter: "blur(24px)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
        ...
        <div className="ll-header-right">
          ...
          <span className="ll-username" style={{ fontSize: 12, color: "#334155", maxWidth: 110, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{user.email.split("@")[0]}</span>
      ...
      {activeTab === "generator" && (
        <div className="ll-section-pad" style={{ maxWidth: 900, margin: "0 auto", animation: "ll-fade 0.4s ease" }}>
          ...
          <div className="ll-card" style={{ padding: "28px", marginBottom: 20 }}>
            {/* Inputs */}
            <div className="ll-grid-inputs" style={{ marginBottom: 22 }}>
              <div>
      ...
      {activeTab === "admin" && isAdmin && (
        <div className="ll-section-pad" style={{ maxWidth: 980, margin: "0 auto", animation: "ll-fade 0.4s ease" }}>
          <div style={{ marginBottom: 28 }}>
          ...
          {adminData && !adminLoading && (
            <>
              <div className="ll-grid-kpi" style={{ marginBottom: 16 }}>
                {[
              ...
              <div className="ll-grid-kpi2" style={{ marginBottom: 20 }}>
                {[
      ...
      <footer style={{ borderTop: "1px solid rgba(255,255,255,0.05)", padding: "28px 28px", textAlign: "center", marginTop: 60 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 20, marginBottom: 14 }}>
          <a href="https://www.instagram.com/latinalabs" target="_blank" rel="noopener noreferrer"
            style={{ display: "flex", alignItems: "center", gap: 7, textDecoration: "none", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 10, padding: "8px 16px", transition: "all 0.2s" }}
            ...
            <span style={{ fontSize: 13, fontWeight: 600, color: "#94a3b8" }}>@latinalabs</span>
          </a>
