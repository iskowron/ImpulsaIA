...
function AuthScreen({ onAuth, onDemo, startMode = "landing" }) {
  ...
  const authFormJSX = (
    <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 24, padding: "32px 28px", boxShadow: "0 40px 80px rgba(0,0,0,0.5)" }}>
      {/* GOOGLE — type="button" evita submit accidental */}
      ...
      {/* TABS — type="button" CRÍTICO: sin esto el browser hace submit y pierde el foco */}
      ...
      {/* FORM — necesario para Tab entre campos y para que el browser maneje autoComplete correctamente */}
